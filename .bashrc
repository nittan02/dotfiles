...
#
if [ -f /cygdrive/c/Users/otani/gitconfig/git-completion.bash ]; then
    source /cygdrive/c/Users/otani/gitconfig/git-completion.bash
fi
if [ -f /cygdrive/c/Users/otani/gitconfig/git-prompt.sh ]; then
    source /cygdrive/c/Users/otani/gitconfig/git-prompt.sh
fi
